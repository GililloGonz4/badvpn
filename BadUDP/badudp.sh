...
if [ "'$1'" == start ]
then
badvpn-udpgw --listen-addr 127.0.0.1:7300 --max-clients 1000 --max-connections-for-client 50 > /dev/null &
...
wget -O /bin/badvpn-udpgw https://raw.githubusercontent.com/scriptsmx/herramientas/tree/master/BadUDP/badvpn-udpgw -o /dev/null
